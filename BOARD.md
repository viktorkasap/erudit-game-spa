### Проверки:
  ...
  -[ ] Слово должно пересекаться с хотя бы одним уже существующим словом на доске. В первом ходе игры это правило не применяется, поскольку на доске еще нет слов.
